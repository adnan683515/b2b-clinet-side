        ...
        <div className={`card ${dark ? 'text-gray-900' : 'bg-white'} border-2 border-orange-300 shadow-md hover:shadow-lg transition duration-300 rounded-xl`}>
            ...
            <div className="card-body space-y-2">
                <h2 className={`card-title text-lg ${dark ? 'text-white' : 'text-cyan-950 '} font-semibold flex justify-between items-center`}>
                    ...
                    <span className={`badge bg-[#f9943b] ${dark ? 'text-black' : 'text-white'} px-3 py-1 rounded-md shadow-sm`}>
                        {item?.price} tk
                    </span>
                </h2>
                ...
                <div className="card-actions justify-between pt-2">
                    <Link
                        to={`/update/${item?._id}`}
                        className="border-2 border-orange-300 text-[#f9943b] font-medium px-4 py-1 rounded hover:bg-orange-100 transition"
                    >
                        Update
                    </Link>
                    <Link
                        to={`/details/${item?._id}`}
                        className="bg-[#08566e] text-white font-medium px-4 py-1 rounded hover:bg-cyan-900 transition"
                    >
                        View More
                    </Link>
                </div>
