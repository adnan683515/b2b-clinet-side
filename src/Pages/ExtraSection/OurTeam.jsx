            ...
            <div className="py-6  w-full ">
                <div className=" flex flex-col ">
                    ...
                    <div className='flex justify-center items-center '>
                        <div className="grid grid-cols-1  sm:grid-cols-2 md:grid-cols-4  mt-8 gap-2 w-[90%]  sm:w-full ">

                            <div className={`flex   w-full flex-col justify-center     my-12 text-center ${dark ? 'bg-gray-900' : 'bg-neutral-200'} rounded-lg shadow-lg `}>
                                <img
                                    alt="Profile"
                            ...
                            <div className={`flex  flex-col justify-center   my-12 text-center ${dark ? 'bg-gray-900' : 'bg-neutral-200'} rounded-lg shadow-lg `}>
                                <img
                                    alt="Profile"
