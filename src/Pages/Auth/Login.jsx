...
const Login = () => {
    ...
    const { login, gooleLogin } = useContext(Authcontext)
    ...
    return (
        ...
        //     <div className='py-3  flex justify-around  flex-col space-y-2 sm:space-y-0 sm:flex-row   '>
        //         <Lottie className='md:w-[30%]  sm:w-[70%] w-[100%]   ' animationData={loginlottie}></Lottie>

        //         <div className="md:w-[30%] mt-4 md:mt-0 sm:w-[70%] w-[100%] md:p-8 px-5 py-2 space-y-1    bg-neutral-200">
        ...
        <div className="w-[98%] max-w-7xl mx-auto py-10 px-4">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-6 bg-white rounded-xl shadow-lg p-6">
                ...
                <div className="w-full sm:w-1/2 md:w-1/3 bg-neutral-100 rounded-lg p-6 space-y-5">
                    <h1 className="text-3xl font-bold text-center text-cyan-950">Login</h1>
